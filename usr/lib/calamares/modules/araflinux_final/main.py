...
def run():
    ...
    libcalamares.utils.debug("Start araflinux_final module")
    libcalamares.utils.debug("#################################\n")
    ...
    # --- Araflinux virtual machine check ---
    libcalamares.utils.debug("##############################################")
    ...
    # --- Remove araflinux-calamares-config package ---
    libcalamares.utils.debug("##############################################")
    libcalamares.utils.debug("Removing araflinux-calamares-config package")
    libcalamares.utils.debug("##############################################\n")
    
    try:
        subprocess.run(
            ["chroot", target_root, "pacman", "-R", "--noconfirm", "araflinux-calamares-config"],
            check=True
        )
    except subprocess.CalledProcessError as e:
        libcalamares.utils.warning(f"Failed to remove araflinux-calamares-config: {e}")

    libcalamares.utils.debug("##############################################")
    libcalamares.utils.debug("End araflinux_final module")
    libcalamares.utils.debug("##############################################\n")
